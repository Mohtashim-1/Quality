...
frappe.ui.form.on('Daily Random Inspection', {
	po: function (frm) {
		frm.doc.items = [];
...
frappe.ui.form.on('Daily Checking Inspection CT', {
	...
	audit_qty: function (frm, cdt, cdn) {
		...
		//     console.log(d)
		//     let major = d.miss_pick__double_pick_qty || 99
		//     console.log("miss_pick__double_pick_qty"+d.miss_pick__double_pick_qty)
		// let major_total = d.miss_pick__double_pick_qty
		//     frappe.model.set_value(d.doctype, d.name, 'major', major);  
...
frappe.ui.form.on('Daily Checking Inspection CT', {
	...
	items_remove: function (frm, cdt, cdn) {
		var d = locals[cdt][cdn];
		var total_defects = 0;
		frm.doc.items.forEach(function (d) { total_defects += d.total; });
		frm.set_value('total_defects', total_defects);
		refresh_field('total_defects');
	}
});
